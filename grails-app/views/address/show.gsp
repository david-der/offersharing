	...
	<body>
		...
		<div id="show-address" class="content scaffold-show" role="main">
			...
			<ol class="property-list address">
				...
				<g:if test="${addressInstance?.addr2}">
				<li class="fieldcontain">
					<span id="addr2-label" class="property-label"><g:message code="address.addr2.label" default="Addr2" /></span>
					
						<span class="property-value" aria-labelledby="addr2-label"><g:fieldValue bean="${addressInstance}" field="addr2"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${addressInstance?.addr1}">
				<li class="fieldcontain">
					<span id="addr1-label" class="property-label"><g:message code="address.addr1.label" default="Addr1" /></span>
					
						<span class="property-value" aria-labelledby="addr1-label"><g:fieldValue bean="${addressInstance}" field="addr1"/></span>
